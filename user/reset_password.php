...
<head>
    ...
    <style>
      ...
      .profile-form input { width: 100%; padding: 12px; border-radius: 8px; border: 1.5px solid #e0c9b2; margin-top: 6px; font-size: 1.08em; margin-bottom: 10px; }
      .profile-actions { display: flex; gap: 18px; margin-top: 24px; width: 100%; justify-content: flex-end; }
      .btn-password { background: #c77d41; color: white; border: none; border-radius: 6px; padding: 10px 16px; font-weight: bold; transition: 0.3s; }
    ...
    <div class="user-content">
        <div class="profile-card">
            ...
            <?php if (isset($_GET['success'])): ?>
                <div class="success-msg">Password berhasil diubah!</div>
            <?php endif; ?>
            <form class="profile-form" action="reset_password_proses.php" method="POST">
                ...
                <div class="profile-actions">
                    <button type="submit" class="btn-password"><i class="fas fa-key"></i> Simpan Password</button>
