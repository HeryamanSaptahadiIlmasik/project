...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 24 Jul 2025 pada 05.21
...
-- Prosedur
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `GetRuleBasedRecommendation` (IN `p_jenis_kopi` ENUM('Arabika','Robusta'), IN `p_metode_penyajian` ENUM('V60','French Press','Espresso','Tubruk','Cold Brew','Moka Pot','Manual Brew'), IN `p_profil_rasa` ENUM('Fruity','Chocolate','Nutty','Earthy','Floral','Citrus','Caramel','Bitter Chocolate','Honey','Spicy','Bitter','Sweet'), IN `p_proses` ENUM('Washed','Honey','Natural'), OUT `p_recommended_roast` ENUM('light','medium','medium-dark','dark'), OUT `p_rule_applied` VARCHAR(255))   BEGIN
...
(1, 'Ethiopian Yirgacheffe', 'Bright and floral with citrus notes', 'Arabika', 'light', 'Citrus, Floral, Tea-like', 'Floral', 'Washed', 'V60, Pour-over, Aeropress', 'Ethiopia', '18000.00', 'https://images.pexels.com/photos/894695/pexels-photo-894695.jpeg', '2025-07-04 14:43:41'),
(2, 'Colombian Supremo', 'Well-balanced with chocolate and caramel notes', 'Arabika', 'medium', 'Chocolate, Caramel, Nuts', 'Chocolate', 'Honey', 'French Press, Drip', 'Colombia', '16000.00', 'https://images.pexels.com/photos/1695052/pexels-photo-1695052.jpeg', '2025-07-04 14:43:41'),
(3, 'Guatemalan Antigua', 'Full-bodied with smoky and spicy notes', 'Arabika', 'medium', 'Smoky, Spicy, Dark Chocolate', 'Spicy', 'Honey', 'Espresso, French Press', 'Guatemala', '17000.00', 'https://images.pexels.com/photos/1695052/pexels-photo-1695052.jpeg', '2025-07-04 14:43:41'),
(4, 'Sumatra Mandheling', 'Bold and earthy with herbal notes', 'Robusta', 'dark', 'Earthy, Herbal, Bold', 'Earthy', 'Natural', 'Tubruk, French Press', 'Indonesia', '15000.00', 'https://images.pexels.com/photos/894695/pexels-photo-894695.jpeg', '2025-07-04 14:43:41'),
(5, 'Triak Coffee Tubruk', 'Nutty and sweet with caramel undertones', 'Arabika', 'medium', 'Fruity,Chocolate,Floral', 'Nutty', 'Honey', 'Tubruk,Moka Pot, French Press', 'West Java', '34000.00', 'uploads/kopi_687b5386b26236.18719490.jpeg', '2025-07-04 14:43:41'),
(6, 'Java Robusta', 'Strong and bitter with earthy finish', 'Robusta', 'dark', 'Bitter, Strong, Earthy', 'Bitter', 'Natural', 'Espresso, Tubruk', 'Indonesia', '13000.00', 'https://images.pexels.com/photos/894695/pexels-photo-894695.jpeg', '2025-07-04 14:43:41'),
(7, 'Kenya AA', 'Wine-like acidity with fruity notes', 'Arabika', 'light', 'Wine, Fruity, Bright', 'Fruity', 'Washed', 'V60, Pour-over', 'Kenya', '19000.00', 'https://images.pexels.com/photos/894695/pexels-photo-894695.jpeg', '2025-07-04 14:43:41'),
(8, 'Costa Rica Tarrazú', 'Citrusy and bright with honey sweetness', 'Arabika', 'medium', 'Citrus, Honey, Bright', 'Citrus', 'Honey', 'V60, Aeropress', 'Costa Rica', '16000.00', 'https://images.pexels.com/photos/1695052/pexels-photo-1695052.jpeg', '2025-07-04 14:43:41'),
(9, 'Panama Geisha', 'Floral and tea-like with honey notes', 'Arabika', 'light', 'Floral, Tea, Honey', 'Honey', 'Washed', 'V60, Pour-over', 'Panama', '25000.00', 'https://images.pexels.com/photos/894695/pexels-photo-894695.jpeg', '2025-07-04 14:43:41'),
(10, 'Vietnam Robusta', 'Strong and earthy with sweet undertones', 'Robusta', 'medium', 'Strong, Earthy, Sweet', 'Sweet', 'Honey', 'Cold Brew, French Press', 'Vietnam', '12000.00', 'https://images.pexels.com/photos/1695052/pexels-photo-1695052.jpeg', '2025-07-04 14:43:41'),
(11, 'Jamaica Blue Mountain', 'Mild and smooth with caramel notes', 'Arabika', 'medium', 'Mild, Smooth, Caramel', 'Caramel', 'Honey', 'Cold Brew, Drip', 'Jamaica', '35000.00', 'https://images.pexels.com/photos/894695/pexels-photo-894695.jpeg', '2025-07-04 14:43:41'),
(12, 'Yemen Mocha', 'Wine-like with fruity and earthy notes', 'Arabika', 'medium', 'Wine, Fruity, Earthy', 'Fruity', 'Washed', 'Cold Brew, French Press', 'Yemen', '22000.00', 'https://images.pexels.com/photos/1695052/pexels-photo-1695052.jpeg', '2025-07-04 14:43:41'),
(13, 'Triak Cofee Tubruk Robusta', 'sdada', 'Robusta', 'medium', 'Chocolate, Nutty', 'Chocolate', 'Washed', 'Tubruk,Moka Pot, French Press, Espresso', 'West Java', '70000.00', 'uploads/kopi_6878d037b298e4.86737664.jpeg', '2025-07-17 10:28:07');
...
(11, 3, 'Arabika', 'French Press', 'Floral', 'Natural', 'medium', 'Default Rule', '2025-07-14 05:23:41'),
(12, 3, 'Robusta', 'Espresso', 'Earthy', 'Natural', 'dark', 'Rule 8', '2025-07-17 07:49:51'),
(13, 3, 'Arabika', 'Tubruk', 'Honey', 'Washed', 'medium', 'Default Rule', '2025-07-17 09:20:54'),
(14, 3, 'Arabika', 'Tubruk', 'Sweet', 'Natural', 'medium', 'Default Rule', '2025-07-17 09:21:19'),
(15, 3, 'Arabika', 'V60', 'Earthy', 'Washed', 'light', 'Partial Match: Rule 1', '2025-07-19 07:14:14'),
(16, 3, 'Arabika', 'V60', 'Chocolate', 'Natural', 'medium', 'Default Rule', '2025-07-19 07:14:36'),
(17, 3, 'Arabika', 'V60', 'Earthy', 'Natural', 'medium', 'Default Rule', '2025-07-19 07:14:48'),
(19, 3, 'Arabika', 'French Press', 'Chocolate', 'Washed', 'medium', 'Default Rule', '2025-07-19 07:19:47'),
(20, 3, 'Robusta', 'Cold Brew', 'Earthy', 'Natural', 'medium', 'Default Rule', '2025-07-20 05:35:51'),
(21, 3, 'Arabika', 'V60', 'Fruity', 'Washed', 'light', 'Rule 1', '2025-07-22 11:35:39'),
(22, 3, 'Arabika', 'V60', 'Fruity', 'Washed', 'light', 'Rule 1', '2025-07-23 10:14:05'),
(23, 3, 'Robusta', 'Tubruk', 'Floral', 'Natural', 'dark', 'Partial Match: Rule 4', '2025-07-23 10:14:29'),
(24, 3, 'Arabika', 'Tubruk', 'Earthy', 'Natural', 'medium', 'Default Rule', '2025-07-24 03:06:28'),
(25, 3, 'Arabika', 'Tubruk', 'Nutty', 'Natural', 'medium', 'Default Rule', '2025-07-24 03:11:24'),
(26, 3, 'Arabika', 'Tubruk', 'Nutty', 'Natural', 'medium', 'Default Rule', '2025-07-24 03:14:42'),
(27, 3, 'Arabika', 'Tubruk', 'Earthy', 'Natural', 'medium', 'Default Rule', '2025-07-24 03:15:04');
...
INSERT INTO `roasting_rules` (`id`, `rule_name`, `jenis_kopi`, `metode_penyajian`, `profil_rasa`, `proses`, `recommended_roast`, `roasting_notes`, `is_active`, `created_at`) VALUES
(1, 'Rule 1', 'Arabika', 'V60', 'Fruity', 'Washed', 'light', 'Light roast untuk mempertahankan keasaman dan aroma floral', 1, '2025-07-05 06:12:08'),
(2, 'Rule 2', 'Arabika', 'French Press', 'Chocolate', 'Honey', 'medium', 'Medium roast untuk mengembangkan rasa chocolate', 1, '2025-07-05 06:12:08'),
(3, 'Rule 3', 'Arabika', 'Espresso', 'Earthy', 'Natural', 'medium', 'Medium roast untuk espresso dengan karakter nutty', 1, '2025-07-05 06:12:08'),
(4, 'Rule 4', 'Arabika', 'Tubruk', 'Earthy', 'Natural', 'dark', 'Dark roast untuk robusta dengan karakter earthy yang kuat', 1, '2025-07-05 06:12:08'),
(5, 'Rule 5', 'Arabika', 'Cold Brew', 'Fruity', 'Honey', 'medium', 'Medium roast untuk cold brew dengan sentuhan fruity', 1, '2025-07-05 06:12:08'),
(6, 'Rule 6', 'Robusta', 'Tubruk', 'Bitter', 'Natural', 'dark', 'Dark roast untuk tubruk ', 1, '2025-07-05 06:12:08'),
(7, 'Rule 7', 'Arabika', '', 'Sweet', 'Washed', 'medium', 'Medium roast untuk manula brew dengan karakter sweet', 1, '2025-07-05 06:12:08'),
(8, 'Rule 8', 'Robusta', 'Espresso', 'Nutty', 'Natural', 'medium', 'Medium roast untuk espresso robusta yang nutty', 1, '2025-07-05 06:12:08'),
(9, 'Rule 9', 'Arabika', 'Cold Brew', 'Caramel', 'Honey', 'medium', 'Medium roast untuk cold brew dengan rasa caramel', 1, '2025-07-05 06:12:08'),
(10, 'Rule 10', 'Robusta', 'French Press', 'Bitter Chocolate', 'Honey', 'medium', 'Medium roast untuk french press dengan rasa bitter chocolate', 1, '2025-07-05 06:12:08'),
(11, 'Rule 11', 'Arabika', 'V60', 'Honey', 'Washed', 'light', 'Light roast untuk mempertahankan sweetness honey', 1, '2025-07-05 06:12:08'),
(12, 'Rule 12', 'Arabika', 'Tubruk', 'Fruity', 'Washed', 'medium', 'Medium roast untuk tubruk dengan karakter fruity', 1, '2025-07-05 06:12:08'),
(13, 'Rule 13', 'Robusta', 'Tubruk', 'Earthy', 'Natural', 'dark', 'Dark roast untuk tubruk robusta yang kuat', 1, '2025-07-05 06:12:08'),
(14, 'Rule 14', 'Robusta', 'Espresso', 'Bitter', 'Natural', 'dark', 'Dark roast untuk espresso dengan karakter bitter', 1, '2025-07-05 06:12:08'),
(15, 'Rule 15', 'Robusta', 'Espresso', 'Bitter', 'Natural', 'dark', 'Dark roast untuk espresso robusta yang bitter', 1, '2025-07-05 06:12:08'),
(16, 'Rule 16', 'Arabika', 'French Press', 'Chocolate', 'Honey', 'medium', 'Medium roast untuk french press dengan rasa chocolate', 1, '2025-07-05 06:12:08'),
(17, 'Rule 17', 'Arabika', 'V60', 'Floral', 'Washed', 'light', 'Light roast untuk mempertahankan karakter floral', 1, '2025-07-05 06:12:08'),
(18, 'Rule 18', 'Robusta', 'Moka Pot', 'Earthy', 'Natural', 'dark', 'Dark roast untuk moka pot robusta', 1, '2025-07-05 06:12:08'),
(19, 'Rule 19', 'Arabika', 'Espresso', 'Spicy', 'Honey', 'medium', 'Medium-dark roast untuk espresso dengan karakter spicy', 1, '2025-07-05 06:12:08'),
(20, 'Rule 20', 'Robusta', 'Espresso', 'Bitter', 'Natural', 'medium', 'Medium roast untuk espresso robusta yang bitter', 1, '2025-07-05 06:12:08');
...
INSERT INTO `users` (`id`, `username`, `email`, `nama_lengkap`, `alamat`, `no_hp`, `password`, `role`, `created_at`) VALUES
(2, 'admin', 'admin@triakcoffee.com', 'Muhammad Fahmi', 'Kp. Babakan Cianjur RW 7 Kelurahan Regol', '089898978', '$2y$10$CUuhs/5wkPNaWz8wk7VhTehV.tCvKkz8IqyYkRc/vT72wJDd2WR3W', 'admin', '2025-07-05 03:50:51'),
(3, 'user', 'user@gmail.com', 'User ', 'jl. haur panggung\r\n', '081338477245', '$2y$10$X3JM2VTC1BMbMHITXKv9POOF753oFRLyJxBQnsBLs4ETKGGK07ZDG', 'user', '2025-07-05 04:02:03'),
(4, 'heryaman', 'hsaptahadi@gmail.com', NULL, NULL, NULL, '$2y$10$esjy4urQDhvOp/P0e7Hjd.MTjboQEQ6EJIpl3NJImUvTQuQkZPlnS', 'user', '2025-07-21 03:24:55');
...
(2, 3, 'Arabika', 'Tubruk', 'Earthy', 'Natural', 'medium', NULL, '');
